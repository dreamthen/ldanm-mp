  ...
  render() {
    ...
    return (
      <View className='hupu-userInfo'>
        <AcUserInfo visible={show} type='userInfo' text='获取个人信息' callBack={getUserInfoHandler}>
          用户名: {nickName}
          头像: {avatar}
        </AcUserInfo>
        <AcUserInfo visible={showPhone} type='phone' text='获取手机号码' callBack={getPhoneNumberHandler}>
          手机号码: {phone}
        </AcUserInfo>
      </View>
    )
